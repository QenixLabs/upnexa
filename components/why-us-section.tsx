...
const benefits = [
  ...
  },
  {
    ...
    subtitle: "Code that scales from 10 to 10,000 users.",
    description:
      "Proper indexing. Efficient queries. Redis caching. Background jobs. Security best practices. These aren't extras—they're standard.",
  },
  {
    title: "YOU OWN EVERYTHING",
    subtitle: "Complete code ownership. No lock-in.",
    description:
      "Every line becomes yours. Full repository access. Complete documentation. No licensing fees. Hand it off tomorrow if you want.",
  },
  {
    title: "REAL SUPPORT",
